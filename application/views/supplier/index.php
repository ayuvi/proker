											...
											<div class="modal-body">
												...
												<div class="form-group">
													...
													<select class="form-control select2" style="width: 100%;" id="id_kategori_supplier" name="id_kategori_supplier">
														...
														<?php foreach ($combobox_kategori->result() as $rowmenu) { ?>
												...
												<div class="form-group">
													<label>NPWP</label>
													<input type="text" id="npwp_supplier" name="npwp_supplier" class="form-control" placeholder="NPWP">
												</div>
												<div class="form-group">
													<label>PIC</label>
				...
				ajax: 
				{
					...
					data: function ( d ) {
						return $.extend({}, d, { 
							...
							"id_supplier_kategori" 	: $("#id_supplier_kategori_filter").val()
						});
					}
				},
				columns: 
			...
			$('#btnSave').on('click', function () {
				...
				else
				{
					...
					var data = {
						...
						npwp_supplier: $('#npwp_supplier').val(),
			...
			function ViewData(id_supplier)
			{
				...
				else
				{
					...
					$.ajax({
						...
						$('#npwp_supplier').val(data['npwp_supplier']);
