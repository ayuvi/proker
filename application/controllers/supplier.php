    ...
    public function index()
    {
        if ($this->session->userdata('login')) {
            ...
            if (!empty($access['id_menu_details'])) {
                ...
                $data['combobox_bu'] = $this->model_supplier->combobox_bu();
                $data['combobox_kategori'] = $this->model_supplier->combobox_kategori();
    ...
    public function ax_data_supplier()
    {
        if ($this->session->userdata('login')) {
            ...
            if (!empty($access['id_menu_details'])) {
                ...
                $data = $this->model_supplier->getAllsupplier($length, $start, $cari['value'],$id_bu, $id_supplier_kategori)->result_array();
                $count = $this->model_supplier->get_count_supplier($cari['value'],$id_bu, $id_supplier_kategori);
