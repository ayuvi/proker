...
class bahan_bakar extends CI_Controller
{
    ...
    public function ax_set_data()
    {
        if ($this->session->userdata('login')) {
            ...
            $nm_bahan_bakar = $this->input->post('nm_bahan_bakar');
            $active = $this->input->post('active');
            $session = $this->session->userdata('login');
            $data = array(
                'id_bahan_bakar'       => $id_bahan_bakar,
                'nm_bahan_bakar'       => $nm_bahan_bakar,
                'active'               => $active,
            ...
            if(empty($id_bahan_bakar))
                $data['id_bahan_bakar'] = $this->model_bahan_bakar->insert_bahan_bakar($data);
            else
                $data['id_bahan_bakar'] = $this->model_bahan_bakar->update_bahan_bakar($data);
    ...
    public function ax_unset_data()
    {
        if ($this->session->userdata('login')) {
            ...
            $data = array('id_bahan_bakar' => $id_bahan_bakar);
            
            if(!empty($id_bahan_bakar))
                $data['id_bahan_bakar'] = $this->model_bahan_bakar->delete_bahan_bakar($data);
    ...
    public function ax_get_data_by_id()
    {
        if ($this->session->userdata('login')) {
            ...
            if(empty($id_bahan_bakar))
                ...
                $data = $this->model_bahan_bakar->get_bahan_bakar_by_id($id_bahan_bakar);
